...
export const UstadzDashboard: React.FC<UstadzDashboardProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 4 Statistik Cards with Animated Counters */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
        {/* Total Santri */}
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-xs flex items-center gap-3.5 fade-in-up" style={fadeDelay(1)}>
        ...
        {/* Setoran Hari Ini */}
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-xs flex items-center gap-3.5 fade-in-up" style={fadeDelay(2)}>
        ...
        {/* Total Ziyadah */}
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-xs flex items-center gap-3.5 fade-in-up" style={fadeDelay(3)}>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-xs flex items-center gap-3.5 fade-in-up" style={fadeDelay(4)}>
